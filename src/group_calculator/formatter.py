...
def format_group_result(
    group_name: str, sorted_teams: list[TeamStats], is_valid: bool, messages: list[str]
) -> dict[str, Any]:
    ...
    return {
        group_name: {"teams": teams_data, "is_valid": is_valid, "messages": messages}
    }


def format_to_json(group_results: dict[str, Any], indent: int = 2) -> str:
...
def format_all_groups(all_group_results: list[dict[str, Any]]) -> dict[str, Any]:
